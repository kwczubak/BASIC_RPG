...
public class Level {
	...
	public void render(Graphics g) {
		//Only renders what the game camera sees and not the whole map.
	...
	public Tile getTile(int x, int y) {
		...
		//Gives the tiles a Tile from what number they had from the txt.
	...
	private void loadLevel(String path) {
		...
		//Sets each tile a number from the level text documents.
